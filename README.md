...
## Следующие шаги
1. Добавить регистрацию, owner/guest режимы и редактирование профиля поверх уже подключённого PostgreSQL.
2. Реализовать полноценный CRUD книг, цитат, мнений и списков рекомендаций.
