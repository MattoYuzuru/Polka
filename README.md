...
Текущий статус: собран рабочий auth/profile/books foundation с Angular 21, Taiga UI 4, Signal Store, Go API, PostgreSQL и вертикальным срезом `register/login -> JWT session -> owner/guest profile -> create book -> book details`.
...
## Следующие шаги
1. Довести книги до полного CRUD: редактирование, удаление и owner actions.
2. Реализовать полноценные списки рекомендаций.
