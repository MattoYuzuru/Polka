...
Текущий статус: собран рабочий auth/profile/books/recommendation-lists foundation с Angular 21, Taiga UI 4, Signal Store, Go API, PostgreSQL и вертикальным срезом `register/login -> JWT session -> owner/guest profile -> create/edit/delete book -> create/edit/delete recommendation list`.
...
## Следующие шаги
1. Добавить reorder/top-механику и более выразительные owner controls в библиотеке.
...
4. Добавить фильтры, сортировку и статистику чтения за период.
