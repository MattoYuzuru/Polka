...
Текущий статус: собран bootstrap проекта с Angular 21, Taiga UI 4, Signal Store, Go API, Docker Compose и первым вертикальным срезом `login -> public profile -> protected create pages`.

## Стек
- Frontend: Angular 21, TypeScript, Taiga UI 4, RxJS, NgRx Signal Store
- Backend: Go 1.25, chi router, mock API foundation
...
- публичная страница профиля с загрузкой данных из Go API
...
## Следующие шаги
1. Перевести backend с mock foundation на PostgreSQL-модели, миграции и полноценный CRUD.
2. Добавить регистрацию, owner/guest режимы и редактирование профиля.
