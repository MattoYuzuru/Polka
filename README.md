...
Текущий статус: собран рабочий auth/profile foundation с Angular 21, Taiga UI 4, Signal Store, Go API, PostgreSQL и вертикальным срезом `register/login -> JWT session -> owner/guest profile -> profile edit`.
...
## Следующие шаги
1. Реализовать полноценный CRUD книг, цитат, мнений и списков рекомендаций.
2. Добавить реальные owner actions на карточках книг и подборок.
