...
- Текущая ветка: `docs/final-gap-analysis-and-checklist`
- Текущая фаза: финальный gap analysis, import JSON и подготовка к продовому handoff
...
5. Закрыть `docs/release-readiness.md`: prod smoke, Lighthouse и Figma, если она обязательна для финальной сдачи.
...
- `curl -X POST /api/v1/books/import`
